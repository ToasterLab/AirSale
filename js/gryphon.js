...
$(document).ready(function() {
	...
	$('#about1').fadeIn(1000);
	$('#adiv1').on('mouseover',function() {$('#about1').animate({fontSize:'40'},500) });
	$('#adiv2').on('mouseover',function() {$('#about2').animate({fontSize:'40'},500) });
	$('#adiv3').on('mouseover',function() {$('#about3').animate({fontSize:'40'},500) });
	HAnimate();
});
