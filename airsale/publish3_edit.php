...
<div class='container'>
    ...
    <div class='panel-body' style="background-color:#EEEEEE">
        <div class='btn-group btn-group-justified' role='group'>
            ...
            <div class='btn-group'>
            <a href="/airsale/publish2_edit" class='btn btn-default btn-lg'>Step 2: Tell others what I am selling	</a>
            </div>
            <div class='btn-group'>
            <a href="/airsale/publish3_edit" class='btn btn-default btn-lg active'>Step 3: Confirm details and strike a deal!</a>
        	</div>
        </div>
        <br>
        <div class="progress">
