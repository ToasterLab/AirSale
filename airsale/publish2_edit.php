...
<div class='container'>
    ...
    <div class='panel-body'>
        <div class='btn-group btn-group-justified' role='group'>
            <div class='btn-group '>
            <a href="/airsale/publish1_edit" class='btn btn-default btn-lg'>Step 1: Update/Confirm profile information</a>
            </div>
            <div class='btn-group'>
            <a href="#" class='btn btn-default btn-lg active'>Step 2: Tell others what I am selling	</a>
            </div>
            <div class='btn-group'>
            <a href="/airsale/publish3_edit" class='btn btn-default btn-lg'>Step 3: Confirm details and strike a deal!</a>
        	</div>
        </div>
        <br>
        <div class="progress">
...
<div class='container'>
    ...
    <br><center><label for='instruction'> Compulsory fields are marked with an asterisk (*). Please complete this page with the most accurate description possible. Also, you may wish to browse the airport websites to find out what is available at your destination.<br>NOTE: Your item needs to be approved AGAIN once you have updated any information on this page.</label><br><br></center>
        ...
        <input class='form-control' type="number" name='flightNumber' id='flightNumber'>
        </div>
...
function formUpdate()
{
	...
	$.post('http://airsale.lalx.org/api/airsale',{JSON:1,action:'session'},function(data) {
		JSession=$.parseJSON(data);
		item_id = Number( JSession['item_id']);
		$.post('http://airsale.lalx.org/api/airsale',{JSON:1,action:'seller_history'},function(data) {
...
function getCarrierFullName()
{
	...
	$.post('../api/airsale',{JSON:1,action:'getCarrierFullName',flightCarrier:$('#flightCarrier').val()},function(data) {
